...
select 
staff.first_name,staff.last_name, sum(payment.amount) as 'Total Amount', month(payment_date) as 'Month', year(payment_date) as 'Year' 
...
select  film_actor.film_id,film.title, count(*) as 'Total Actors' 
from film_actor 
inner join 
	film 
on 
